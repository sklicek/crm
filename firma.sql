...
INSERT INTO `kontenrahmen` (`id_konto`, `konto_nr`, `bezeichnung`, `typ`) VALUES
(1, 100, 'Allgemeines Ausgabenkonto (kein passenderes Konto?)', 'A'),
(2, 110, 'Waren, Rohstoffe und Hilfsstoffe	', 'A'),
(3, 111, 'Bürobedarf', 'A'),
(4, 112, 'Fortbildung, Fachliteratur', 'A'),
(5, 113, 'Verbrauchsmaterial (bitte auf Konto 110 buchen)', 'A'),
(6, 114, 'Rechts- und Steuerberatung, Buchführung', 'A'),
(7, 120, 'Bezogene Leistungen für unmittelbaren Betriebszweck', 'A'),
(8, 121, 'Porto', 'A'),
(9, 122, 'Telekommunikation', 'A'),
(10, 123, 'Energie', 'A'),
(11, 124, 'Beiträge, Gebühren, Abgaben und Versicherungen (ohne Gebäude und Kfz)', 'A'),
(12, 125, 'Werbekosten (z.B. Inserate, Werbespots, Plakate)', 'A'),
(13, 130, 'Gehälter, Löhne, Versicherungsbeiträge für Arbeitnehmer', 'A'),
(14, 140, 'Aufwendungen für geringwertige Wirtschaftsgüter (GWG)', 'A'),
(15, 150, 'Miete/Pacht für Geschäftsräume', 'A'),
(16, 155, 'Miete/Leasing für bewegliche Wirtschaftsgüter', 'A'),
(17, 160, 'Aufwendungen für Grundstücke', 'A'),
(18, 170, 'Aufwendungen für ein häusl. Arbeitszimmer', 'A'),
(19, 180, 'Verpflegungsmehraufwendungen', 'A'),
(20, 181, 'Fahrtkosten öffentlich (Bahn, ÖPNV, Taxi)', 'A'),
(21, 182, 'Übernachtungs- und Reisenebenkosten bei Geschäftsreisen', 'A'),
(22, 183, 'Privat-PKW für betriebliche Fahrten', 'A'),
(23, 184, 'Laufende und feste KFZ-Kosten ohne AFA und Zinsen', 'A'),
(24, 185, 'Miete / Aufwendungen für doppelte Haushaltsführung', 'A'),
(25, 186, 'KFZ-Leasingkosten', 'A'),
(26, 187, 'Steuern, Versicherung, Maut für KFZ', 'A'),
(27, 188, 'KFZ-Kosten für Wege zwischen Wohnung und Betriebsstätte; Familienheimfahrten', 'A'),
(28, 189, 'Mindestens abziehbare KFZ-Kosten für Wege zw. Wohnung und Betriebsstätte (Entf.pauschale); Familienheimfahrten	', 'A'),
(29, 190, 'Geschenke - abziehbar', 'A'),
(30, 195, 'Geschenke - nicht abziehbar', 'A'),
(31, 200, 'Bewirtung - abziehbar', 'A'),
(32, 205, 'Bewirtung - nicht abziehbar', 'A'),
(33, 210, 'Sonstige abziehbare Betriebsausgaben', 'A'),
(34, 215, 'Sonstige nicht abziehbare Betriebsausgaben', 'A'),
(35, 220, 'Instandhaltung und Reparaturen', 'A'),
(36, 230, 'Betriebsausgabenpauschale für bestimmte Berufsgruppen', 'A'),
(37, 235, 'Freibetrag nach §3 Nr.26 und 26a EStG', 'A'),
(38, 240, 'Schuldzinsen (Finanzierung von Anschaffungs-/Herstellungskosten von Wirtschaftsgütern)', 'A'),
(39, 245, 'Übrige Schuldzinsen (nicht abziehbar)', 'A'),
(40, 246, 'Übrige Schuldzinsen (abziehbar)', 'A'),
(41, 300, 'AfA auf unbewegliche Wirtschaftsgüter', 'A'),
(42, 310, 'AfA auf immaterielle Wirtschaftsgüter', 'A'),
(43, 320, 'AfA auf bewegliche Wirtschaftsgüter', 'A'),
(44, 330, 'Sonderabschreibungen nach §7g EStG', 'A'),
(45, 340, 'Herabsetzungsbeträge nach §7g Abs. 2 EStG', 'A'),
(46, 350, 'Auflösung Sammelposten nach §6 Abs. 2a EStG', 'A'),
(47, 360, 'Restbuchwert der im Kalenderjahr/Wirtschaftsjahr ausgeschiedenen Anlagegüter', 'A'),
(48, 496, 'Gewerbesteuer - nicht abziehbar', 'A'),
(49, 497, 'Gewerbesteuer - abziehbar', 'A'),
(50, 498, 'Vorsteuerbeträge', 'A'),
(51, 499, 'An das FA gezahlte Umsatzsteuer', 'A'),
(52, 500, 'Allgemeines Einnahmenkonto', 'E'),
(53, 600, 'Veräußerung und Entnahme von Anlagevermögen', 'E'),
(54, 610, 'Sonstige Sach-, Nutzungs- und Leistungsentnahmen', 'E'),
(55, 620, 'Private KFZ-Nutzung', 'E'),
(56, 630, 'Private Telefonnutzung', 'E'),
(57, 998, 'Vereinnahmte Umsatzsteuer', 'E'),
(58, 999, 'Vom FA erstattete Umsatzsteuer', 'E');
